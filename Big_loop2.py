...
for i in range(200):
    ...
    line_number_sf1, line_number_sp1, line_number_sfns1, line_number_spns1, line_number_res1 = mould_result_filter(
        grayline1, line_number_f1, line_number_p1, res1)
    line_number_sf2, line_number_sp2, line_number_sfns2, line_number_spns2, line_number_res2 = mould_result_filter(
        grayline2, line_number_f2, line_number_p2, res2)
    ...
    trust1, peaks_line1 = add_mould_result(peaks_line1, trust1, line_number_sf1, line_number_sp1, peaks_diff1,
                                           dead_range1, mean_size)
    trust2, peaks_line2 = add_mould_result(peaks_line2, trust2, line_number_sf2, line_number_sp2, peaks_diff2,
                                           dead_range2, mean_size)
